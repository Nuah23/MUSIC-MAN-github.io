...
String[] songs = {
  "assets/audio/Drake - Laugh Now Cry Later (Instrumental) ft. Lil Durk - M Max.mp3",
  "assets/audio/JACKBOYS, Travis Scott - OUT WEST (Audio) ft. Young Thug (OFFICIAL INSTRUMENTAL).mp3",
  "assets/audio/Three 6 Mafia - Poppin' My Collar [Instrumental] - Crucial Mixtapes.mp3"
};
